...
int main(int argc, char *argv[])
{
	...
	pthread_create(&t[2], NULL, func3, NULL);
	pthread_create(&t[3], NULL, func4, NULL);
	pthread_create(&t[4], NULL, func5, NULL);
	pthread_create(&t[5], NULL, func6, NULL);
	pthread_create(&t[6], NULL, func7, NULL);
